				...
				if(allowUpdate) {
					for(EntityUIPlanet entity : entities) {
						...
						if(entity != centeredEntity)
							entity.setPositionPolar(this.pos.getX() + .5, this.pos.getY() + 1, this.pos.getZ() + .5, getInterpHologramSize()*(.1+ properties.getOrbitalDist()/100f), properties.getOrbitTheta());
