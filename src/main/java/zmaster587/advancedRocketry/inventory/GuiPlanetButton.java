...
public class GuiPlanetButton extends GuiImageButton {
	...
	public void drawButton(Minecraft minecraft, int par2, int par3, float f)
	{
		if (this.visible)
		{
	        ...
	        RenderPlanetarySky.renderPlanetPubHelper(vertexbuffer, properties.getPlanetIcon(), (int)(x + newWidth), -(int)(y + newWidth), (double)this.zLevel, newWidth, 1f, properties.getOrbitTheta(), properties.hasAtmosphere(), properties.skyColor, properties.ringColor, properties.isGasGiant(), properties.hasRings(),properties.hasDecorators());
            GL11.glPopMatrix();
